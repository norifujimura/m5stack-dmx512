...
int transmitPin    = 32; //14 for core2-M5GO Bottom2 ,2 for ATOMS3, 32 for core2
int receivePin     = 33; //13 for core2-M5GO Bottom2, 1 for ATOMS3, 33 for core2
int enablePin      = -1;
dmx_port_t dmxPort = 0;// 1 for core2-M5GO, 0 for ATOMS3, 0or1 with 12Ohm switch ON  for core2, 
